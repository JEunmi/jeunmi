$(document).ready(function () {
    ...
    $('#fullpage').fullpage({
        menu: '#nav',
        anchors:['part1','part2', 'part3', 'part4','part5','part5'],
        ...
        // onLeave: function (index, nextIndex, direction) {
            ...
            if (index == 1 && nextIndex == 2 && direction == 'down') {
                ...
                //
                $(".part5 .logo").addClass("animate__animated animate__fadeInLeft").css('animation-delay', '.5s');
                $(".part5 .text_box h2").addClass("animate__animated animate__fadeInLeft").css('animation-delay', '.5s');
                $(".part5 .text_box p").addClass("animate__animated animate__fadeInLeft").css('animation-delay', '.5s');
                $(".part5 .text_box .button a").addClass(" animate__animated animate__fadeIn").css('animation-delay', '.8s');
                $(".part5 .screen").addClass("animate__animated animate__fadeInRight").css('animation-delay', '.5s');
            }else if ((index == 1 || index == 2 || index == 3 || index == 4 || index == 5) && nextIndex == 6 && direction == 'down') {
                $(".part5 .logo").removeClass("animate__animated animate__fadeInLeft").css('animation-delay', '.5s');
                $(".part5 .text_box h2").removeClass("animate__animated animate__fadeInLeft").css('animation-delay', '.5s');
                $(".part5 .text_box p").removeClass("animate__animated animate__fadeInLeft").css('animation-delay', '.5s');
                $(".part5 .text_box .button a").removeClass(" animate__animated animate__fadeIn").css('animation-delay', '.8s');
                $(".part5 .screen").removeClass("animate__animated animate__fadeInRight").css('animation-delay', '.5s');
                //
                $(".part6 h2").addClass("animate__animated  animate__backInDown").css('animation-delay', '.3s');
                $(".part6 p").addClass("animate__animated animate__fadeInUp").css('animation-delay', '.8s');
            }else{
                $(".part6 h2").removeClass("animate__animated  animate__backInDown").css('animation-delay', '.3s');
                $(".part6 p").removeClass("animate__animated animate__fadeInUp").css('animation-delay', '.8s');
            }
        },
    })
    // swiper
